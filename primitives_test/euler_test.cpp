...
#include "../primitives/euler.h"
#include "../primitives/RefBlas.h"

#include "test_functions.h"


TEST(EulerTest,SolvesTestEq1){
	...
	solve_fixedstep<float,RefBlas,EulerStep>(ndim,
		0.0f,dend,
		step,
		equation,
		init.data(),
...
TEST(EulerTest,SolvesTestEq2){
	...
	solve_fixedstep<double,RefBlas,EulerStep>(ndim,
		0.0f,dend,
		step,
		sin_eq,
		init.data(),
...
TEST(HeunTest,SolvesTestEq1){
	...
	solve_fixedstep<float,RefBlas,HeunStep>(ndim,
		0.0f,dend,
		step,
		equation,
		init.data(),
...
TEST(HeunTest,SolvesTestEq2){
	...
	solve_fixedstep<double,RefBlas,HeunStep>(ndim,
		0.0f,dend,
		step,
		sin_eq,
		init.data(),
